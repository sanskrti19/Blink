  ...
  return (
    <section className="pt-24 pb-20 text-center px-4 bg-gray-50/50"> 
      <div className="max-w-5xl mx-auto">
        ...
        {/* Call-to-Action */}
        <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3.5 px-8 rounded-xl text-lg shadow-lg hover:shadow-xl transition duration-300 transform hover:scale-[1.02]">
          Start Organizing — It's Free
        </button>
        
        {/* Subtle secondary action */}
        <p className="mt-4 text-sm text-gray-500">
          Already have an account? <span className="text-indigo-600 font-medium cursor-pointer hover:underline">Log in here.</span>
        </p>

        {/* Placeholder for the App Mockup (Crucial for the Notion look) */}
